...
trait Listable {
     ...
     * @param bool        $indexed       By default, indexes by {@link self::$listKey}. If this param is given,
     ...
     * @return array
     */
    public static function toList($include_empty = false, $indexed = false, $field = null) {
        $list    = static::orderBy(static::$listKey)->get()->toArray();
        $columns = array_column($list, $field?: static::$listField, $indexed? null : static::$listKey);
     ...
     * @return array
     */
    public static function toTransList($include_empty = false, $indexed = false, $field = null) {
        $list = static::toList($include_empty, $indexed, $field);
