...
<div class="container">
    <div class="row">
        <h2><?=_('Who\'s behind this?')?></h2>
            <p><?=_r('Besides being a open-source project, there\'s a solo developer behind the project. After seven years of experience with web development and always experimenting new technologies, %sI (Igor)%s decided to start this platform after hitting the head on the wall while trying to plan my participation on some tech conferences. Later, talking with some friends and colleagues about their student lives, I\'ve also noticed how troublesome is the advertisement and discovery of small events, talks or congresses, and finally took the lead to create a revolution on event information online.',
        ...
        <dl>
            ...
            <dt><a href="https://laravel.com" target="_blank">Laravel 5</a></dt>
            ...
            <dt><a href="https://www.digitalocean.com/?refcode=a875fa6ef2b6" target="_blank">Digital Ocean</a></dt>
            ...
            <dt><a href="https://www.heroku.com" target="_blank">Heroku</a></dt>
        ...
        <dl>
            <dt><a href="https://www.bitbucket.org" target="_blank">Bitbucket</a></dt>
            <dd>
            ...
            <dt><a href="https://www.browserstack.com" target="_blank">BrowserStack</a></dt>
            ...
            <dt><a href="https://www.rescuetime.com/ref/1098140" target="_blank">RescueTime</a></dt>
