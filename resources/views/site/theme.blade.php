...
@section('title', 'Theme demonstration')
...
@section('content')
    ...
    <p>Here we use <a href="http://semantic-ui.com">Semantic UI</a>. As it's very theme-able, we're showcasing here all the fancy widgets it has, under our own theme. Most of what's here is based on the original
        <a href="http://semantic-ui.com/examples/theming.html">Theme Example</a>. <b>Enjoy!</b></p>

    <h2 class="ui dividing header">Site colours & customized components</h2>

    <h3 class="ui header">Main pallete (customized colours)</h3>
    <div class="ui four column stackable padded grid">
        <div class="column orange">orange <b>(primary)</b></div>
        <div class="column blue">blue <b>(secondary)</b></div>
        <div class="column teal">teal</div>
        <div class="column yellow">yellow</div>
    </div>

    <h3 class="ui header">Other colours (original settings)</h3>
    <div class="ui three column stackable padded grid">
        <div class="column olive">olive</div>
        <div class="column green">green</div>
        <div class="column violet">violet</div>
        <div class="column purple">purple</div>
        <div class="column pink">pink</div>
        <div class="column red">red</div>
        <div class="column brown">brown</div>
        <div class="column grey">grey</div>
        <div class="column black">black</div>
    </div>

    <h3 class="ui header">Alert messages</h3>
    <div class="ui two column padded grid">
        <div class="column"><div class="ui positive message">Great! Your stuff is saved.</div></div>
        <div class="column"><div class="ui info message">We have news for you: <a href="#">good news</a></div></div>
        <div class="column"><div class="ui warning message">Watch out! The floor is slipery!</div></div>
        <div class="column"><div class="ui error message">Whoops! Something nasty happened :(</div></div>
    </div>

    <h2 class="ui dividing header">Typography</h2>
    ...
    <div class="ui stackable equal width grid">
        <div class="column">
            <div class="ui three column stackable grid">
                <div class="column"><button class="ui button">Default</button></div>
                <div class="column"><button class="ui primary button">Primary</button></div>
                <div class="column"><button class="ui secondary button">Secondary</button></div>
                <div class="column"><button class="ui basic button">Basic</button></div>
                <div class="column"><button class="ui compact button">Compact</button></div>
            </div>
            ...
            <div class="ui attached segment">
                <img src="http://semantic-ui.com/examplhttp://semantic-ui.com/examples/assets/images/wireframe/paragraph.png" class="ui wireframe image">
            </div>
        ...
        <div class="column">
            ...
            <div class="ui divider"></div>
            <div class="ui three column stackable grid">
                <div class="column"><button class="yellow ui button">Yellow</button></div>
                <div class="column"><button class="orange ui button">Orange</button></div>
                <div class="column"><button class="green ui button">Green</button></div>
                <div class="column"><button class="teal ui button">Teal</button></div>
                <div class="column"><button class="blue ui button">Blue</button></div>
                <div class="column"><button class="purple ui button">Purple</button></div>
                <div class="column"><button class="pink ui button">Pink</button></div>
                <div class="column"><button class="red ui button">Red</button></div>
                <div class="column"><button class="black ui button">Black</button></div>
            </div>

            <div class="ui divider"></div>
            <div class="ui inverted segment">
                <div class="ui two column stackable grid">
                    <div class="column"><button class="ui inverted button">Inverted</button></div>
                    <div class="column"><button class="ui inverted basic button">Basic</button></div>
                    <div class="column"><button class="ui inverted blue button">Colored</button></div>
                    <div class="column"><button class="ui inverted blue basic button">Basic Colored</button></div>
                </div>
            </div>
        </div>
    </div>
    ...
    <h2 class="ui dividing header">Forms</h2>
    <div class="ui two column stackable grid">
        <div class="column">
    ...
    <h2 class="ui dividing header">Cards</h2>
        ...
        <div class="ui card">
            <div class="ui slide right reveal image">
                <div class="visible content">
                    <img class="ui fluid image" src="http://semantic-ui.com/examples/assets/images/avatar/nan.jpg">
                </div>
                <div class="hidden content">
                    <img class="ui fluid image" src="http://semantic-ui.com/examples/assets/images/avatar/tom.jpg">
                </div>
            </div>
            <div class="content">
                <img src="http://semantic-ui.com/examples/assets/images/wireframe/paragraph.png" class="ui wireframe image">
            </div>
        </div>
        <div class="ui card">
    ...
    <div class="ui four cards">
      ...
      <span class="right floated star">
        ...
        <div class="ui card">
            <div class="content">
                <div class="header">
                    <img src="http://semantic-ui.com/examples/assets/images/wireframe/square-image.png" class="ui avatar right spaced image">
                    Abbreviated Header
                </div>
        ...
        <a href="#" class="ui card">
            ...
            <div class="extra content">
                <div class="right floated author">
                    <img src="http://semantic-ui.com/examples/assets/images/wireframe/square-image.png" class="ui avatar image"> Username
                </div>
            </div>
        </a>
        <div class="ui card">
