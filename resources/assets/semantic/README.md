...
This is how installation was done at the first time (and if you're redoing it you'll want to keep most settings):
    ...
    $ npm install semantic-ui --save
        Is this your project folder? /home/igoru/dev/konato/web  [Yes]
        ...
        [...]
    $ cd resources/assets/semantic/
    $ gulp build # if you don't have global gulp installed, use ../../../node_modules/
